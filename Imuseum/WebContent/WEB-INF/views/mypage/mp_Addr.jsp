	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h1 class="modal-title fs-5" id="staticBackdropLabel">주소추가</h1>
	      ...
	      <div class="modal-body">
	      	<div class="body_addr">
		        ...
		        <button type="button" onclick="addrSearch()">우편번호 찾기</button>
		        <input type="text" id="sample2_address" placeholder="주소" readonly="readonly">
		        <input type="text" id="sample2_detailAddress" placeholder="상세주소" readonly="readonly">
	      	</div>
	      	<div class="body_getter">
	      		수령인*<br>
